...
export function buildMarkdownReport(stats, generatedAt = new Date()) {
  ...
  return [
    ...
    "- It can explain both hits and misses through `/leaderboard`, `/stats`, `/rejections`, and saved scan history.",
    ...
    "- The same ID appears in `/radar`, `/why`, `/flow`, `/leaderboard`, and `/stats`.",
